...
data = pd.read_csv('Assignment/1_Regression/data/train.csv', encoding = 'big5')
...
testdata = pd.read_csv('Assignment/1_Regression/data/test.csv', header = None, encoding = 'big5')
